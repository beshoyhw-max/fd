...
class Config:
    ...
    @property
    def font_consistency_dir(self) -> Path:
        rel = self._data.get("data", {}).get("font_consistency_dir", "data/font_consistency")
        return PROJECT_ROOT / rel

    def ensure_data_dirs(self):
        """Create all data directories if they don't exist."""
        for d in [self.invoices_dir, self.results_dir, self.exports_dir, self.ela_output_dir, self.font_consistency_dir]:
